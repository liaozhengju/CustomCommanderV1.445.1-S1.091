...
# conventional wife increases player's family members' attributes
    (4, 1440, ti_once,
     [
                (troop_slot_ge, "trp_player", slot_troop_spouse, 0),
                (troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse),
                (troop_get_slot, ":lady_reputation", ":player_spouse", slot_lord_reputation_type),
                (eq, ":lady_reputation", lrep_conventional),
                #(store_relation, ":relation", "trp_player", ":player_spouse"),
                #(ge, ":relation", 50),
     ],
     [
         (display_message, "@Your wife has taken a good care of you which you benefits a lot from ", 0x88FF88),
     ...
     [
                (troop_slot_ge, "trp_player", slot_troop_spouse, 0),
                (troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse),
                (troop_slot_ge, ":player_spouse", slot_troop_guardian, 0),
                (troop_get_slot, ":lady_reputation", ":player_spouse", slot_lord_reputation_type),
                (eq, ":lady_reputation", lrep_conventional),
                #(store_relation, ":relation", "trp_player", ":player_spouse"),
                #(ge, ":relation", 50),
     ...
     [
     (troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse), 
    (troop_get_slot, ":spouse_guardian", ":player_spouse", slot_troop_guardian),
    (display_message, "@Your whole family benefits a lot from your wife's work ", 0x88FF88),                      
               (troop_raise_attribute, ":spouse_guardian", ca_charisma, 1),
               (troop_raise_attribute, ":spouse_guardian", ca_intelligence, 1),
       ]
     ...
     [
                (troop_slot_ge, "trp_player", slot_troop_spouse, 0),
                (troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse),
                (troop_slot_ge, ":player_spouse", slot_troop_father, 0),
                (troop_get_slot, ":lady_reputation", ":player_spouse", slot_lord_reputation_type),
                (eq, ":lady_reputation", lrep_conventional),
                #(store_relation, ":relation", "trp_player", ":player_spouse"),
                #(ge, ":relation", 50),
     ...
     [
     (troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse), 
    (troop_get_slot, ":spouse_father", ":player_spouse", slot_troop_father),
    (troop_get_slot, ":spouse_mother", ":player_spouse", slot_troop_mother),    
    (display_message, "@Your whole family benefits a lot from your wife's work ", 0x88FF88),     
               (troop_raise_attribute, ":spouse_father", ca_charisma, 1),
               (troop_raise_attribute, ":spouse_father", ca_intelligence, 1),
               (troop_raise_attribute, ":spouse_mother", ca_charisma, 1),
               (troop_raise_attribute, ":spouse_mother", ca_intelligence, 1),
    (try_for_range, ":cur_troop", lords_begin, lords_end),
    (troop_get_slot, ":troop_father", ":cur_troop", slot_troop_father),
    (eq, ":troop_father", ":spouse_father"),
    (troop_raise_attribute, ":cur_troop", ca_charisma, 1),
    (troop_raise_attribute, ":cur_troop", ca_intelligence, 1),
               
       ]

     ),
     # adventurous wife increases player's attributes
    (4, 1440, ti_once,
     [
                (troop_slot_ge, "trp_player", slot_troop_spouse, 0),
                (troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse),
     ...
     [
         (display_message, "@Your wife's valor affects you, which makes you more skillful in combat ", 0x88FF88),
               (troop_raise_attribute, "trp_player", ca_strength, 1),
               (troop_raise_attribute, "trp_player", ca_agility, 1),
               #(troop_raise_attribute, "trp_player", ca_charisma, 1),
               #(troop_raise_attribute, "trp_player", ca_intelligence, 1),
...
# moralist wife give divine armor
    (4, 1, ti_once,
     [
                (troop_slot_ge, "trp_player", slot_troop_spouse, 0),
                (troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse),
     ...
     [
         (display_message, "@ The Templar has heard of our family's renown and gave you a set of armor as award  ", 0x88FF88),
           (troop_add_item, "trp_player", "itm_divine_armor", 0),
           (troop_add_item, "trp_player", "itm_divine_helmet", 0),
           (troop_add_item, "trp_player", "itm_divine_boots", 0),
       ]

     ),
# otherworldly wife give death eye
    (4, 1, ti_once,
     [
                (troop_slot_ge, "trp_player", slot_troop_spouse, 0),
                (troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse),
     ...
     [
         (display_message, "@ Your wife gave you a bow and told you that a mystic told her to hand on it to you. When you touch the bow you feel that it's draining your life force ", 0xFF0000),
           (troop_add_item, "trp_player", "itm_death_eye", 0),
           (troop_raise_attribute, "trp_player", ca_strength, -1),
       ]
