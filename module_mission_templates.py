    ...
    [
      (try_for_agents, ":agent_no"),
        ...
        (try_begin),
          ...
          (else_try), # lefthand skill(skl_shield) to increase bow damage, 3% per level
            (eq, ":item_type", itp_type_bow),
            (store_skill_level, ":skill_level", "skl_shield", ":troop_no"),
            (store_mul, ":ranged_damage_modifier", ":skill_level", 3),
            (val_add, ":ranged_damage_modifier", 100),
          (else_try), # lefthand skill(skl_shield) to increase two_handed_wpn damage, 3% per level
            ...
            (try_begin), 
              ...
              (store_skill_level, ":skill_level", "skl_shield", ":troop_no"),
              (store_mul, ":damage_modifier", ":skill_level", 3),
              (val_add, ":damage_modifier", 100),
            (try_end),
          (else_try), # lefthand skill(skl_shield) to increase polearm damage, 3% per level
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (store_mul, ":damage_ratio", ":skill_level", -3),
