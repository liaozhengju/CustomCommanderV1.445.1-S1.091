...
##  ("noble_refugees", "Noble Refugees", icon_gray_knight|carries_goods(12)|pf_quest_party,0,fac_noble_refugees,merchant_personality,[(trp_noble_refugee,3,5),(trp_noble_refugee_woman,5,7)]),
  ...
  ("reserves_party","Reserves",icon_gray_knight|carries_goods(1)|pf_show_faction,0,fac_commoners,bandit_personality,[]),
  ## CC
...
## CC 
  ...
  ("kingdom_1_reinforcements_c_hero", "{!}kingdom_1_reinforcements_c_hero", 0, 0, fac_commoners, 0, [(trp_swadian_knight,2,3),(trp_swadian_man_at_arms,1,2)]),
  ...
  ("kingdom_2_reinforcements_c_hero", "{!}kingdom_2_reinforcements_c_hero", 0, 0, fac_commoners, 0, [(trp_vaegir_knight,2,3),(trp_vaegir_horseman,1,2)]),
  ...
  ("kingdom_3_reinforcements_c", "{!}kingdom_3_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_khergit_lancer,1,3),(trp_khergit_veteran_horse_archer,1,2),(trp_khergit_horseman,1,3)]),
  ("kingdom_3_reinforcements_c_hero", "{!}kingdom_3_reinforcements_c_hero", 0, 0, fac_commoners, 0, [(trp_khergit_khan_guard,2,3),(trp_khergit_lancer,1,2)]),
  ...
  ("kingdom_4_reinforcements_c_hero", "{!}kingdom_4_reinforcements_c_hero", 0, 0, fac_commoners, 0, [(trp_nord_scout,1,3),(trp_nord_champion,2,3)]),
  ...
  ("kingdom_5_reinforcements_c_hero", "{!}kingdom_5_reinforcements_c_hero", 0, 0, fac_commoners, 0, [(trp_rhodok_scout,1,3),(trp_rhodok_sharpshooter,2,3),(trp_rhodok_veteran_spearman,1,2)]),
  ...
  ("kingdom_6_reinforcements_c_hero", "{!}kingdom_6_reinforcements_c_hero", 0, 0, fac_commoners, 0, [(trp_sarranid_mamluke,2,3),(trp_sarranid_horseman,1,2)]),
