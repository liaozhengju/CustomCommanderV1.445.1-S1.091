...
# Carthorse, hunter, heavy hunter, hackney, palfrey, courser, destrier.
 ...
 ["saddle_horse","Saddle Horse", [("saddle_horse",0),("horse_c",imodbits_horse_good)], itp_merchandise|itp_type_horse, 0, 180,abundance(90)|hit_points(100)|body_armor(8)|difficulty(1)|horse_speed(45)|horse_maneuver(44)|horse_charge(10)|horse_scale(104),imodbits_horse_basic],
...
["warhorse_e","Scale Draped Warhorse", [("warhorse_e",0)], itp_merchandise|itp_type_horse, 0, 1500,abundance(50)|hit_points(165)|body_armor(45)|difficulty(4)|horse_speed(40)|horse_maneuver(41)|horse_charge(30)|horse_scale(110),imodbits_horse_basic|imodbit_champion],
 ...
 ["heavy_saddle_horse","Heavy Saddle Horse", [("saddle_horse",0),("horse_c",imodbits_horse_good)], itp_merchandise|itp_type_horse, 0, 396,abundance(90)|hit_points(110)|body_armor(11)|difficulty(1)|horse_speed(45)|horse_maneuver(44)|horse_charge(14)|horse_scale(114),imodbits_horse_basic],
...
235 , weight(6)|difficulty(1)|spd_rtng(95) | shoot_speed(28) | thrust_damage(18 ,  pierce)|max_ammo(7)|weapon_length(32),imodbits_thrown, [], [fac_kingdom_1]],
...
430 , weight(7.5)|difficulty(1)|spd_rtng(93) | shoot_speed(27) | thrust_damage(21 ,  pierce)|max_ammo(7)|weapon_length(45),imodbits_thrown,[], [fac_kingdom_1]],
## CC
...
480, weight(3.75)|difficulty(1)|spd_rtng(91) | shoot_speed(25) | thrust_damage(31 ,  pierce)|max_ammo(5)|weapon_length(75)|accuracy(104),imodbits_thrown,[], [fac_kingdom_4, fac_kingdom_6]],
...
790 , weight(4)|difficulty(2)|spd_rtng(87) | shoot_speed(22) | thrust_damage(40 ,  pierce)|max_ammo(4)|weapon_length(65)|accuracy(114),imodbits_thrown,[], [fac_kingdom_4, fac_kingdom_6]],
...
840 , weight(4)|difficulty(2)|spd_rtng(89) | shoot_speed(24) | thrust_damage(41 ,  pierce)|max_ammo(4)|weapon_length(65)|accuracy(115),imodbits_thrown,[], [fac_kingdom_4, fac_kingdom_6]],
...
672 , weight(3.5)|difficulty(1)|spd_rtng(85) | shoot_speed(20) | thrust_damage(44,  pierce)|max_ammo(3)|weapon_length(96)|accuracy(118),imodbits_thrown_minus_heavy,[], []],
...
728 , weight(4)|difficulty(2)|spd_rtng(83) | shoot_speed(18) | thrust_damage(48,  pierce)|max_ammo(3)|weapon_length(108)|accuracy(122),imodbits_thrown_minus_heavy,[], []],
...
350 , weight(7.5)|difficulty(1)|spd_rtng(97) | shoot_speed(30) | thrust_damage(16,  pierce)|max_ammo(10)|weapon_length(50),imodbits_thrown,[], [fac_kingdom_2, fac_kingdom_3]],

#TODO:
#TODO: Heavy throwing Spear
["stones",         "Stones", [("throwing_stone",0)], itp_type_thrown |itp_merchandise|itp_primary ,itcf_throw_stone, 2 , weight(8)|difficulty(0)|spd_rtng(97) | shoot_speed(30) | thrust_damage(7 ,  blunt)|max_ammo(18)|weapon_length(8),imodbit_large_bag],
["throwing_knives", "Throwing Knives", [("throwing_knife",0)], itp_type_thrown |itp_merchandise|itp_primary ,itcf_throw_knife, 114 , weight(3.5)|difficulty(0)|spd_rtng(121) | shoot_speed(25) | thrust_damage(15 ,  cut)|max_ammo(14)|weapon_length(0),imodbits_thrown],
...
["throwing_daggers", "Throwing Daggers", [("throwing_dagger",0)], itp_type_thrown |itp_merchandise|itp_primary ,itcf_throw_knife, 289 , weight(3.25)|difficulty(0)|spd_rtng(110) | shoot_speed(24) | thrust_damage(21 ,  cut)|max_ammo(13)|weapon_length(0),imodbits_thrown],
...
540, weight(5)|difficulty(2)|spd_rtng(99) | shoot_speed(18) | thrust_damage(31,cut)|max_ammo(4)|weapon_length(53)|accuracy(105),imodbits_thrown_minus_heavy,[], [fac_kingdom_4]],
...
735, weight(6)|difficulty(3)|spd_rtng(98) | shoot_speed(18) | thrust_damage(35,cut)|max_ammo(4)|weapon_length(53)|accuracy(109),imodbits_thrown_minus_heavy,[], [fac_kingdom_4]],
...
930, weight(7)|difficulty(4)|spd_rtng(97) | shoot_speed(18) | thrust_damage(40,cut)|max_ammo(4)|weapon_length(53)|accuracy(114),imodbits_thrown_minus_heavy,[], [fac_kingdom_4]],
...
600 , weight(6.25)|difficulty(2)|spd_rtng(95)|shoot_speed(20)|thrust_damage(29, blunt)|max_ammo(5)|weapon_length(55)|accuracy(103), imodbits_thrown],
...
["throwing_swords",        "Throwing Swords", [("throwing_sword",0),("throwing_sword_quiver", ixmesh_carry),("throwing_sword_inventory", ixmesh_inventory)], itp_type_thrown|itp_merchandise|itp_primary|itp_next_item_as_melee, itcf_throw_axe|itcf_carry_quiver_front_right|itcf_show_holster_when_drawn,
 800 , weight(9)|difficulty(2)|spd_rtng(105)|shoot_speed(16)|thrust_damage(30,cut)|max_ammo(6)|weapon_length(65)|accuracy(104),imodbits_thrown],
...
["divine_armor", "Divine Armor", [("full_plate_armor",0)], itp_type_body_armor  |itp_covers_legs ,0,
 18553 , weight(30)|abundance(100)|head_armor(0)|body_armor(100)|leg_armor(40)|difficulty(15) ,imodbits_plate ],
["divine_boots", "Divine Boots", [("iron_greaves_a",0)], itp_type_foot_armor | itp_attach_armature,0,
 6870 , weight(5)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(50)|difficulty(15) ,imodbits_armor ],
["divine_helmet", "Divine Helmet", [("great_helmet_new",0)],  itp_type_head_armor|itp_covers_head,0, 8880 , weight(4)|abundance(100)|head_armor(80)|body_armor(0)|leg_armor(0)|difficulty(15) ,imodbits_plate ],
["death_eye",  "Death Eye", [("darkbow",0)], itp_type_bow |itp_primary|itp_two_handed ,itcf_shoot_bow|itcf_carry_bow_back|itp_extra_penetration,
9964 , weight(2.25)|difficulty(5)|spd_rtng(90) | shoot_speed(70) | thrust_damage(35 ,  pierce)|accuracy(99),imodbits_bow ],
["telson",         "Telson", [("dao_modify",0)], itp_type_one_handed_wpn|itp_primary|itp_secondary|itp_no_parry, itc_dagger|itcf_carry_dagger_front_left,
1037 , weight(1.0)|difficulty(0)|spd_rtng(150) | weapon_length(60)|swing_damage(40 , cut) | thrust_damage(51 ,  pierce),imodbits_sword_high ],
["pelage_armour_armor", "Pelage Armor", [("BM_pelage_armour",0)],  itp_type_body_armor |itp_covers_legs ,0,
 5321 , weight(26)|abundance(100)|head_armor(0)|body_armor(54)|leg_armor(16)|difficulty(9) ,imodbits_armor ],
["assassin_armor", "Assassin Armor", [("BM_assassin_outf",0)],  itp_type_body_armor |itp_covers_legs  ,0, 5665 , weight(20)|abundance(100)|head_armor(8)|body_armor(53)|leg_armor(16)|difficulty(9) ,imodbits_armor ],
["red_tabard", "Red Tabard", [("bm_tabard_red",0)],  itp_type_body_armor |itp_covers_legs  ,0, 4265 , weight(22)|abundance(100)|head_armor(0)|body_armor(50)|leg_armor(14)|difficulty(9) ,imodbits_armor ],
["fur_nomad_armor", "Fur Nomad Armor", [("BM_nomad_armor",0)],  itp_type_body_armor |itp_covers_legs  ,0, 4265 , weight(24)|abundance(100)|head_armor(0)|body_armor(50)|leg_armor(14)|difficulty(9) ,imodbits_armor ],
["merchant_cloak", "Merchant Cloak", [("BM_BlackWhite_armour",0)],  itp_type_body_armor |itp_covers_legs  ,0, 4865 , weight(24)|abundance(100)|head_armor(0)|body_armor(50)|leg_armor(14)|difficulty(9) ,imodbits_armor ],
["eagle_plate", "Eagle Plate", [("bm_surcoat_a",0)], itp_type_body_armor  |itp_covers_legs ,0,
 8553 , weight(28)|abundance(100)|head_armor(4)|body_armor(58)|leg_armor(18)|difficulty(10) ,imodbits_plate ],
["silver_plate", "Silver Plate", [("BM_silver_remake_brigandine",0)], itp_type_body_armor  |itp_covers_legs ,0,
 8853 , weight(30)|abundance(100)|head_armor(0)|body_armor(58)|leg_armor(18)|difficulty(10) ,imodbits_plate ],
["forest_warrior_armor", "Forest Warrior Armor", [("BM_sandsnake_warrior",0)],  itp_type_body_armor |itp_covers_legs  ,0, 4865 , weight(24)|abundance(100)|head_armor(0)|body_armor(54)|leg_armor(16)|difficulty(9) ,imodbits_armor ],
["ocean_warrior_armor", "Ocean Warrior Armor", [("bm_chaintunic_a",0)],  itp_type_body_armor |itp_covers_legs  ,0, 4865 , weight(24)|abundance(100)|head_armor(0)|body_armor(54)|leg_armor(16)|difficulty(9) ,imodbits_armor ],
["white_sergeant_chain_mail", "White Sergeant Chain Mail", [("BM_gambeson2",0)],  itp_type_body_armor |itp_covers_legs  ,0, 4865 , weight(24)|abundance(100)|head_armor(0)|body_armor(50)|leg_armor(14)|difficulty(9) ,imodbits_armor ],
["black_sergeant_chain_mail", "Black Sergeant Chain Mail", [("BM_gambeson",0)],  itp_type_body_armor |itp_covers_legs  ,0, 4865 , weight(24)|abundance(100)|head_armor(0)|body_armor(50)|leg_armor(14)|difficulty(9) ,imodbits_armor ],
["pilgrim_chain_mail", "Pilgrim Chain Mail", [("BM_armed_pilgrim_outfit",0)],  itp_type_body_armor |itp_covers_legs  ,0, 4865 , weight(24)|abundance(100)|head_armor(0)|body_armor(50)|leg_armor(14)|difficulty(9) ,imodbits_armor ],
["silver_scale_armor", "Silver Scale Armor", [("bm_surcoat_b",0)],  itp_type_body_armor |itp_covers_legs  ,0, 7312 , weight(26)|abundance(100)|head_armor(0)|body_armor(56)|leg_armor(16)|difficulty(10) ,imodbits_armor ],
["black_knight_armor", "Black Knight Armor", [("bm_tabard_black",0)],  itp_type_body_armor |itp_covers_legs  ,0, 8512 , weight(28)|abundance(100)|head_armor(0)|body_armor(56)|leg_armor(18)|difficulty(10) ,imodbits_armor ],
["rich_chain_mail", "Rich Chain Mail", [("bm_byrnie_a",0)],  itp_type_body_armor |itp_covers_legs  ,0, 4865 , weight(24)|abundance(100)|head_armor(0)|body_armor(50)|leg_armor(14)|difficulty(9) ,imodbits_armor ],
["khan_helmet", "Khan Helmet", [("BM_skull_hat_c.1",0)],  itp_type_head_armor| itp_doesnt_cover_hair ,0, 2880 , weight(4)|abundance(100)|head_armor(56)|body_armor(0)|leg_armor(0)|difficulty(10) ,imodbits_plate ],
["pillager_helmet", "Pillager Helmet", [("BM_skull_hat_a.1",0)],  itp_type_head_armor| itp_doesnt_cover_hair ,0, 2480 , weight(4)|abundance(100)|head_armor(54)|body_armor(0)|leg_armor(0)|difficulty(10) ,imodbits_plate ],
["forest_warrior_helmet", "Forest Warrior Helmet", [("BM_skull_hat_b.1",0)],  itp_type_head_armor| itp_doesnt_cover_hair ,0, 2280 , weight(3.5)|abundance(100)|head_armor(52)|body_armor(0)|leg_armor(0)|difficulty(9) ,imodbits_plate ],
["assassin_hood", "Assassin Hood", [("BM_assassin_hood",0)],  itp_type_head_armor,0, 2280 , weight(2)|abundance(100)|head_armor(52)|body_armor(0)|leg_armor(0)|difficulty(9) ,imodbits_plate ],
["pilgrim_chain_hood", "Pilgrim Chain Hood", [("BM_armed_hood",0)],  itp_type_head_armor,0, 2000 , weight(2)|abundance(100)|head_armor(50)|body_armor(0)|leg_armor(0)|difficulty(9) ,imodbits_plate ],
["milan_plate", "Milan Plate", [("pa",0)], itp_type_body_armor  |itp_covers_legs ,0,
 9553 , weight(31)|abundance(100)|head_armor(10)|body_armor(60)|leg_armor(20)|difficulty(12) ,imodbits_plate ],
["milan_helmet", "Milan Helmet", [("ph",0)],  itp_type_head_armor|itp_covers_head,0, 4880 , weight(4)|abundance(100)|head_armor(60)|body_armor(0)|leg_armor(0)|difficulty(12) ,imodbits_plate ],
["horse_merchant_helmet", "Horse Merchant Helmet", [("neckguard_helm_new",0)],  itp_type_head_armor   ,0,
1590 , weight(1.9)|abundance(100)|head_armor(50)|body_armor(0)|leg_armor(0)|difficulty(9) ,imodbits_plate ],
["businessmen_hat", "Businessmen Hat", [("fur_hat_a_new",0)],  itp_type_head_armor   ,0, 1040 , weight(0.9)|abundance(100)|head_armor(50)|body_armor(0)|leg_armor(0)|difficulty(9) ,imodbits_plate],
["lass_helmet","Lass Helmet",[("arena_helmetR",0)],itp_type_head_armor,0,1026, weight(2)|head_armor(50)|difficulty(9) ,imodbits_plate],
["ocean_warrior_helmet", "Ocean Warrior Helmet", [("Helmet_C",0)],  itp_type_head_armor ,0, 1880 , weight(2.25)|abundance(100)|head_armor(52)|body_armor(0)|leg_armor(0)|difficulty(10) ,imodbits_plate ],
["long_kitchen_chopper",         "Long Kitchen Chopper", [("bm_cleaver_staff165",0)], itp_type_polearm|itp_offset_lance| itp_primary|itp_two_handed|itp_wooden_parry, itc_glaive|itcf_carry_spear,
 652 , weight(4.5)|difficulty(9)|spd_rtng(90) | weapon_length(165)|swing_damage(40 , cut) | thrust_damage(0 ,  pierce),imodbits_polearm ],
["spear_with_hooked_sickle",         "Spear With Hooked Sickle", [("bm_1knife_staff165",0)], itp_type_polearm|itp_offset_lance| itp_primary|itp_two_handed|itp_wooden_parry, itc_glaive|itcf_carry_spear,
 652 , weight(4.5)|difficulty(9)|spd_rtng(90) | weapon_length(165)|swing_damage(41 , cut) | thrust_damage(40 ,  pierce),imodbits_polearm ],
