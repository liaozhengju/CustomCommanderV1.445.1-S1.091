...
[
    ...
    (4,  # Locate kingdom ladies
     [(try_begin),
      ...
      # (try_for_range, ":troop_id", kingdom_ladies_begin, kingdom_ladies_end),
      # (troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse),
      # (main_party_has_troop,":player_spouse"),
      # (try_end),
      # (try_end),
      (try_begin),
      (try_for_range, ":troop_id", kingdom_ladies_begin, kingdom_ladies_end),
      (troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse),
      (eq, ":troop_id", ":player_spouse"),
      (neg | main_party_has_troop, ":player_spouse"),
      (neg | troop_slot_ge, ":troop_id", slot_troop_prisoner_of_party, 0),
      (call_script, "script_get_kingdom_lady_social_determinants", ":troop_id"),
      (assign, ":location", reg1),
      (troop_set_slot, ":troop_id", slot_troop_cur_center, ":location"),
  ...
  # Give some xp to hero parties
   ...
   [      
       (try_for_range, ":troop_no", active_npcs_begin, active_npcs_end),
         ...
         (val_add, ":trainer_level", 0), #average trainer level is 3 for npc lords, worst : 0, best : 6
         (store_mul, ":xp_gain", ":trainer_level", 500), #xp gain in two days of period for each lord, average : 8000(1500).
       ...
       (try_for_range, ":center_no", walled_centers_begin, walled_centers_end),         
         ...
         (assign, ":xp_gain", 1000), #xp gain in two days of period for each center, average : 3000(1000).
...
############################################### wife ability
# increase relation with player's wife
(168,[
  (troop_get_type, ":is_female", "trp_player"),
  (neq, ":is_female", 1),
  (troop_slot_ge, "trp_player", slot_troop_spouse, 0), #player married
  (troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse),
  (troop_get_slot, ":lady_reputation", ":player_spouse", slot_lord_reputation_type),
  (try_begin),
    (eq, ":lady_reputation", lrep_benefactor), # benefactor
    (display_message, "@As time goes by, you and your wife becomes more intimate ", 0x88FF88),
    (call_script, "script_troop_change_relation_with_troop", "trp_player", ":player_spouse", 5),
    (else_try),
    (eq, ":lady_reputation", lrep_conventional), # conventional
    (display_message, "@As time goes by, you and your wife becomes more intimate ", 0x88FF88),
    (call_script, "script_troop_change_relation_with_troop", "trp_player", ":player_spouse", 7),
    (else_try),
    (display_message, "@As time goes by, you and your wife becomes more intimate ", 0x88FF88),
    (call_script, "script_troop_change_relation_with_troop", "trp_player", ":player_spouse", 2),
  (try_end),
]),
# village relation (ambitious or moralist or benefactor)
(168,[
  (troop_slot_ge, "trp_player", slot_troop_spouse, 0), # player married
  (try_for_range, ":cur_village", villages_begin, villages_end),
  (party_slot_eq, ":cur_village", slot_town_lord, "trp_player"), #village belongs to player
  (troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse),
  (troop_get_slot, ":lady_reputation", ":player_spouse", slot_lord_reputation_type),
  (try_begin),
    (eq, ":lady_reputation", lrep_ambitious), # lady_ambitious
    (display_message, "@Your wife's work has improved your villages' prosperity and your relationship with them", 0x88FF88),
    (call_script, "script_change_player_relation_with_center", ":cur_village", 1),  # relation+1
    (call_script, "script_change_center_prosperity", ":cur_village", 1),  # prosperity+1
  (else_try),
    (eq, ":lady_reputation", lrep_moralist), # lady_moralist
    (display_message, "@Your wife's work has improved your villages' prosperity and your relationship with them", 0x88FF88),
    (call_script, "script_change_player_relation_with_center", ":cur_village", 1),  # relation+1
    (call_script, "script_change_center_prosperity", ":cur_village", 1),  # prosperity+1
  (else_try),
    (eq, ":lady_reputation", lrep_benefactor), # lady_benefactor
    (display_message, "@Your wife's work has improved your villages' prosperity and your relationship with them", 0x88FF88),
    (call_script, "script_change_player_relation_with_center", ":cur_village", 3),  # relation+3
    (call_script, "script_change_center_prosperity", ":cur_village", 3),  # prosperity+3
  (try_end),
(try_end),
    ]),
# town and castle relation (ambitious or moralist or benefactor)
(168,[
  ...
  (try_begin),
    (eq, ":lady_reputation", lrep_ambitious), # lady_ambitious
    (display_message, "@Your wife's work has improved your towns' and castles' prosperity and your relationship with them ", 0x88FF88),
    (call_script, "script_change_player_relation_with_center", ":center_no", 1),
    (call_script, "script_change_center_prosperity", ":center_no", 1),
  (else_try),
    (eq, ":lady_reputation", lrep_moralist), # lady_moralist
    (display_message,"@Your wife's work has improved your towns' and castles' prosperity and your relationship with them ", 0x88FF88),
    (call_script, "script_change_player_relation_with_center", ":center_no", 1),  # relation+1
    (call_script, "script_change_center_prosperity", ":center_no", 1),  # prosperity+1
  (else_try),
    (eq, ":lady_reputation", lrep_benefactor), # lady_benefactor
    (display_message,"@Your wife's work has improved your towns' and castles' prosperity and your relationship with them ", 0x88FF88),
    (call_script, "script_change_player_relation_with_center", ":center_no", 3),  # relation+3
    (call_script, "script_change_center_prosperity", ":center_no", 3),  # prosperity+3
  (try_end),
(try_end),
    ]),
# increase honor (moralist)
(168,[
  (troop_slot_ge, "trp_player", slot_troop_spouse, 0),
  (troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse),
  (troop_get_slot, ":lady_reputation", ":player_spouse", slot_lord_reputation_type),
  (try_begin),
    (eq, ":lady_reputation", lrep_moralist), # lady_moralist
    (display_message, "@Your wife's moral has increased your honor ", 0x88FF88),
    (call_script, "script_change_player_honor", 2),
  (try_end),
]),
# increase relation with wife's father and brother (conventional)
...
(168,[
  ...
  (troop_get_slot, ":lady_reputation", ":player_spouse", slot_lord_reputation_type),
  (try_begin),
    (eq, ":lady_reputation", lrep_conventional), # lady_conventional
    (troop_get_slot, ":spouse_guardian", ":player_spouse", slot_troop_guardian),
    (display_message, "@Your wife's work has improved your relationship with your brother-in-law", 0x88FF88),
    (call_script, "script_troop_change_relation_with_troop", "trp_player", ":spouse_guardian", 10),
  (try_end),
]),
(168,[
  (troop_slot_ge, "trp_player", slot_troop_spouse, 0),
  ...
  (try_begin),
    ...
    (display_message, "@Your wife's work has improved your relationship with your father-in-law and mother-in-law", 0x88FF88),
    (call_script, "script_troop_change_relation_with_troop", "trp_player", ":spouse_father", 10),
    (call_script, "script_troop_change_relation_with_troop", "trp_player", ":spouse_mother", 10),
    (try_for_range, ":cur_troop", lords_begin, lords_end),
    (troop_get_slot, ":troop_father", ":cur_troop", slot_troop_father),
    (eq, ":troop_father", ":spouse_father"),
    (display_message, "@Your wife's work has improved your relationship with your brother-in-law", 0x88FF88),
    (call_script, "script_troop_change_relation_with_troop", "trp_player", ":cur_troop", 10),
    (try_end),
  (try_end),
 ]),
# randomly increase or decrease honor and renown( otherworldly)
(168,[
  (troop_slot_ge, "trp_player", slot_troop_spouse, 0),
  (troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse),
  (troop_get_slot, ":lady_reputation", ":player_spouse", slot_lord_reputation_type),
  (try_begin),
    (eq, ":lady_reputation", lrep_otherworldly), # lady_otherworldly
    (store_random_in_range, ":random", 1, 10),
    (try_begin),
      (le, ":random", 3),
      (display_message, "@Your wife's improper behaviour has decreased your renown and honor", 0xFF0000),
      (call_script, "script_change_player_honor", -1),
      (call_script, "script_change_troop_renown", "trp_player", -5),
    (else_try),
      (display_message, "@Your wife's unconventional behaviour has increased your renown and honor", 0x88FF88),
...
# add troops to player's center (adventurous)
#(168,[
  #(troop_slot_ge, "trp_player", slot_troop_spouse, 0),
  #(troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse),
  #(troop_get_slot, ":lady_reputation", ":player_spouse", slot_lord_reputation_type),
  #(try_begin),
    #(eq, ":lady_reputation", lrep_adventurous), # lady_adventurous
    #(troop_get_slot, ":location", ":player_spouse", slot_troop_cur_center),
    #(is_between, ":location", walled_centers_begin, walled_centers_end),
    #(display_message, "@Your wife has used your money to train some soldiers, now they are in your wife's castle", 0x88FF88),
    #(troop_add_gold,"trp_player",-1000),
    #(party_add_members, ":location", "trp_mercenary_horseman", 6),
#(try_end),
#]),
 # martial wife
(168,[
  (troop_get_type, ":is_female", "trp_player"),
  (neq, ":is_female", 1), # player is male
  (troop_slot_ge, "trp_player", slot_troop_spouse, 0),
  (troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse),
  (troop_get_slot, ":lady_reputation", ":player_spouse", slot_lord_reputation_type),
  (try_begin),
    (eq, ":lady_reputation", lrep_martial), # martial
    (store_random_in_range, ":random", 1, 17),
    (try_begin),
      (eq, ":random", 2),
      (display_message, "@Your wife gives you a special item that she just captured", 0x88FF88),
      (troop_add_item, "trp_player","itm_steel_lance",0),
    (else_try),
      (eq, ":random", 3),
      (display_message, "@Your wife gives you a special item that she just captured", 0x88FF88),
      (troop_add_item, "trp_player","itm_steel_long_bow",0),
    (else_try),
      (eq, ":random", 4),
      (display_message, "@Your wife gives you a special item that she just captured", 0x88FF88),
      (troop_add_item, "trp_player","itm_steel_shield",0),
    (else_try),
      (eq, ":random", 5),
      (display_message, "@Your wife gives you a special item that she just captured", 0x88FF88),
      (troop_add_item, "trp_player","itm_sword_medieval_e_long",0),
    (else_try),
      (eq, ":random", 6),
      (display_message, "@Your wife gives you a special item that she just captured", 0x88FF88),
      (troop_add_item, "trp_player","itm_warhorse_plate",0),
    (try_end),
(try_end),
]),
...
(168,[
  ...
  (troop_get_slot, ":lady_reputation", ":player_spouse", slot_lord_reputation_type),
  (try_begin),
    (eq, ":lady_reputation", lrep_quarrelsome), # quarrelsome
    (display_message, "@Your wife's followers gave her some money to bribe her, this has decreased your family's renown", 0xFF0000),
...
(168,[
  ...
  (troop_get_slot, ":lady_reputation", ":player_spouse", slot_lord_reputation_type),
  (try_begin),
    (eq, ":lady_reputation", lrep_roguish), # roguish
    (display_message, "@Your wife has extorted the hard-won possession of the people in your villages", 0xFF0000),
    (call_script, "script_change_player_relation_with_center", ":cur_village", -1),  # relation-1
    (call_script, "script_change_center_prosperity", ":cur_village", -1),  # prosperity-1
...
(168,[
  ...
  (try_begin),
    (eq, ":lady_reputation", lrep_roguish), # roguish
    (display_message, "@Your wife has extorted the hard-won possession of the people in your towns and castles ", 0xFF0000),
    (call_script, "script_change_player_relation_with_center", ":center_no", -1),
    (call_script, "script_change_center_prosperity", ":center_no", -1),
...
############################################### husband ability
# increase relation with player's husband
(168,[
  (troop_get_type, ":is_female", "trp_player"),
  (eq, ":is_female", 1), # player is female
  (troop_slot_ge, "trp_player", slot_troop_spouse, 0), #player married
  (troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse),
  (troop_get_slot, ":husband_reputation", ":player_spouse", slot_lord_reputation_type),
  (try_begin),
    (eq, ":husband_reputation", lrep_benefactor), # benefactor
    (display_message, "@As time goes by, you and your husband becomes more intimate ", 0x88FF88),
    (call_script, "script_troop_change_relation_with_troop", "trp_player", ":player_spouse", 3),
    (else_try),
    (eq, ":husband_reputation", lrep_goodnatured), # goodnatured
    (display_message, "@As time goes by, you and your husband becomes more intimate ", 0x88FF88),
    (call_script, "script_troop_change_relation_with_troop", "trp_player", ":player_spouse", 3),
    (else_try),
    (display_message, "@As time goes by, you and your husband becomes more intimate ", 0x88FF88),
...
# benefactor and goodnatured husband
(168,[(troop_get_type, ":is_female", "trp_player"),
  (eq, ":is_female", 1), # player is female
  (troop_slot_ge, "trp_player", slot_troop_spouse, 0), # player married
  (try_for_range, ":cur_village", villages_begin, villages_end),
  (party_slot_eq, ":cur_village", slot_town_lord, "trp_player"), #village belongs to player
  ...
  (try_begin),
    (eq, ":husband_reputation", lrep_benefactor), # benefactor
    (display_message, "@Your husband's work has improved your villages' prosperity and your relationship with them", 0x88FF88),
    (call_script, "script_change_player_relation_with_center", ":cur_village", 1),  # relation+1
    (call_script, "script_change_center_prosperity", ":cur_village", 1),  # prosperity+1
    (else_try),
    (eq, ":husband_reputation", lrep_goodnatured),  # goodnatured
...
(168,[(troop_get_type, ":is_female", "trp_player"),
    ...
    (try_begin),
    (eq, ":husband_reputation", lrep_benefactor),  # benefactor
    (display_message, "@Your husband's work has improved your towns' and castles' prosperity and your relationship with them ", 0x88FF88),
    (call_script, "script_change_player_relation_with_center", ":center_no", 1),
    (call_script, "script_change_center_prosperity", ":center_no", 1),
    (else_try),
    (eq, ":husband_reputation", lrep_goodnatured), # goodnatured
...
(168,[
  ...
  (troop_get_slot, ":husband_reputation", ":player_spouse", slot_lord_reputation_type),
  (try_begin),
    (eq, ":husband_reputation", lrep_cunning), # cunning
    (display_message, "@Your husband's gift has increased your relationship with him", 0x88FF88),
    (call_script, "script_troop_change_relation_with_troop", "trp_player", ":player_spouse", 5),
    (troop_add_gold,"trp_player",250),
  (try_end),
]),
# selfrighteous_husband
(168,[
  (troop_get_type, ":is_female", "trp_player"),
  (eq, ":is_female", 1),
  (troop_slot_ge, "trp_player", slot_troop_spouse, 0),
  ...
  (troop_get_slot, ":husband_reputation", ":player_spouse", slot_lord_reputation_type),
  (try_begin),
    (eq, ":husband_reputation", lrep_selfrighteous), # selfrighteous
    (display_message, "@Your husband's charm has increased your family's renown", 0x88FF88),
    (call_script, "script_change_troop_renown", "trp_player", 10),
  (try_end),
]),
# quarrelsome and custodian husband
(168,[
  (troop_get_type, ":is_female", "trp_player"),
  (eq, ":is_female", 1),
  (troop_slot_ge, "trp_player", slot_troop_spouse, 0),
  ...
  (troop_get_slot, ":husband_reputation", ":player_spouse", slot_lord_reputation_type),
  (try_begin),
    (eq, ":husband_reputation", lrep_quarrelsome), # quarrelsome
    (display_message, "@Your husband's followers gave him some money to bribe him, which has decreased your family's renown", 0xFF0000),
    (troop_add_gold,"trp_player",400),
    (call_script, "script_change_troop_renown", "trp_player", -5),
    (else_try),
    (eq, ":husband_reputation", lrep_custodian),  # custodian
    (display_message, "@Your husband's followers gave him some money to bribe him, which has decreased your family's renown", 0xFF0000),
    (troop_add_gold, "trp_player", 400),
    (call_script, "script_change_troop_renown", "trp_player", -5),
  (try_end),
]),
# debauched and roguish husband
#village relation
(168,[
  (troop_get_type, ":is_female", "trp_player"),
  (eq, ":is_female", 1),
  ...
  (troop_get_slot, ":husband_reputation", ":player_spouse", slot_lord_reputation_type),
  (try_begin),
    (eq, ":husband_reputation", lrep_debauched), # debauched
    (display_message, "@Your husband has extorted the hard-won possession of the people in your villages", 0xFF0000),
    (call_script, "script_change_player_relation_with_center", ":cur_village", -1),  # relation-1
    (call_script, "script_change_center_prosperity", ":cur_village", -1),  # prosperity-1
    (troop_add_gold,"trp_player",250),
    (else_try),
    (eq, ":husband_reputation", lrep_roguish), # roguish
    (display_message, "@Your husband has extorted the hard-won possession of the people in your villages", 0xFF0000),
    (call_script, "script_change_player_relation_with_center", ":cur_village", -1),  # relation-1
    (call_script, "script_change_center_prosperity", ":cur_village", -1),  # prosperity-1
    (troop_add_gold,"trp_player",250),
...
(168,[
  ...
  (try_begin),
    (eq, ":husband_reputation", lrep_debauched), # debauched
    (display_message, "@Your husband has extorted the hard-won possession of the people in your towns and castles ", 0xFF0000),
    (call_script, "script_change_player_relation_with_center", ":center_no", -1),
    (call_script, "script_change_center_prosperity", ":center_no", -1),
    (troop_add_gold,"trp_player",500),
    (else_try),
...
(168,[
  ...
  (troop_get_slot, ":husband_reputation", ":player_spouse", slot_lord_reputation_type),
  (try_begin),
    (eq, ":husband_reputation", lrep_martial), # martial
    (store_random_in_range, ":random", 1, 25),
    (try_begin),
      (eq, ":random", 2),
      (display_message, "@Your husband gives you a special item that he just captured", 0x88FF88),
      (troop_add_item, "trp_player","itm_steel_lance",0),
    (else_try),
      (eq, ":random", 3),
      (display_message, "@Your husband gives you a special item that he just captured", 0x88FF88),
...
#(168,[(troop_get_type, ":is_female", "trp_player"),
    ...
    #(troop_get_slot, ":player_spouse", "trp_player", slot_troop_spouse),
    #(store_current_hours, ":hours_since_last_visit"),
		#(troop_get_slot, ":last_visit_hour", ":player_spouse", slot_troop_last_talk_time),
		#(val_sub, ":hours_since_last_visit", ":last_visit_hour"),
		#(store_div, ":days_since_last_visit", ":hours_since_last_visit", 24),
		#(assign, reg4, ":days_since_last_visit"),
#]),
# increase spouse's family members' relation with ruler
(168,[(troop_get_type, ":is_female", "trp_player"),
  (neq, ":is_female", 1),
  ...
  (try_begin),
    (troop_get_slot, ":spouse_guardian", ":player_spouse", slot_troop_guardian),
    (display_message, "@Your enormous influence in the kingdom makes your family be favored by your monarch.", 0x88FF88),
    (call_script, "script_troop_change_relation_with_troop", ":faction_leader", ":spouse_guardian", 5),
(call_script, "script_troop_change_relation_with_troop", ":faction_leader", ":player_spouse", 5),
  (try_end),
]),
(168,[(troop_get_type, ":is_female", "trp_player"),
  (neq, ":is_female", 1),
 (troop_slot_ge, "trp_player", slot_troop_renown, 900),
  ...
  (try_begin),
    ...
    (troop_get_slot, ":spouse_mother", ":player_spouse", slot_troop_mother),
    (display_message, "@Your enormous influence in the kingdom makes your family be favored by your monarch.", 0x88FF88),
   (call_script, "script_troop_change_relation_with_troop", ":faction_leader", ":spouse_father", 5),
    (call_script, "script_troop_change_relation_with_troop", ":faction_leader", ":spouse_mother", 5),
  (call_script, "script_troop_change_relation_with_troop", ":faction_leader", ":player_spouse", 5),
    (try_for_range, ":cur_troop", lords_begin, lords_end),
    (troop_get_slot, ":troop_father", ":cur_troop", slot_troop_father),
    (eq, ":troop_father", ":spouse_father"),
   (call_script, "script_troop_change_relation_with_troop", ":faction_leader", ":cur_troop", 5),
    (try_end),
  (try_end),
 ]),
(168,[(troop_get_type, ":is_female", "trp_player"),
